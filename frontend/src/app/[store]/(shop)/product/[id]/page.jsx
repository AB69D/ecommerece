...
// Fetch options scoped to the store taken from the URL (/<store>/product/<id>):
// forward X-Tenant and bypass the shared data cache so one store's product page
// never serves another's.
const fetchOpts = (store) =>
    store
