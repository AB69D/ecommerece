...
export default function CmsArticle({ title, html }) {
    return (
        <div className="py-8 px-4 max-w-4xl mx-auto">
            ...
            <div
                className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 text-gray-600 leading-relaxed
                    [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-gray-800 [&_h2]:mt-6 [&_h2]:mb-3 [&_h2]:first:mt-0
                    ...
                    [&_img]:rounded-xl [&_img]:my-4 [&_table]:w-full [&_table]:my-4
